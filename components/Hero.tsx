        ...
        <section className="max-container padding-container flex flex-col
            gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
                ...
                <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
                    <h1 className="bold-52 lg:bold-88"> Comfort Paws </h1>
                    <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]"> We provide extensive animal care for common and exotic pets
